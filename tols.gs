  ...
  var folderList = DriveApp.getFoldersByName(folderName);
    ...
    if (folderList.hasNext()) {
      ...
      if (fileList.hasNext()) {
        ...
        var folder = DriveApp.getFoldersByName('Hibike').next();
        ...
        var randomFile = fileArray[randomIndex];

        Logger.log('Random File Name: ' + randomFile.getName());
      }
    }

  status = "pixiv.net/en/" + randomFile;
  var final = randomFile;
